/* Table Language
 * This table is meant to register the languages that are in use in the database 
 * (not in the app). The system column, meant to be boolean, represents languages 
 * used by the system, so, they cannot be removed by the user.
 */
 ...
 * This table is designed to have only one line, and one column for each 
